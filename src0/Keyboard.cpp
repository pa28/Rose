...
namespace rose {
    ...
    constexpr KeyboardSpec<QUERTY::Rows, QUERTY::KeysPerRow, QUERTY::Depth> QUERTY::QWERTYData = {
            ...
            KeySpecRow<QUERTY::KeysPerRow, QUERTY::Depth>{
                    ...
                    makeKeySpec<QUERTY::Depth>("zZ+@"),
                    makeKeySpec<QUERTY::Depth>("xX--"),
                    makeKeySpec<QUERTY::Depth>("cC'$"),
                    makeKeySpec<QUERTY::Depth>("vV\"%"),
                    makeKeySpec<QUERTY::Depth>("bB_("),
                    makeKeySpec<QUERTY::Depth>("nN?)"),
                    makeKeySpec<QUERTY::Depth>("mM/`"),
